...
typedef struct DirectoryEntry {
    ...
    unsigned int firstBlockIndex;             // First block in the FAT chain
    time_t creationTime;                  // When the file was created
    time_t lastModifiedTime;              // Last modification time
	time_t lastAcessedTime;
    unsigned long fileType;                     // 0 for file, 1 for directory
    unsigned int inUse;                        // 0 for free, 1 for in use
    unsigned int linkCount;                   // Number of hard links
